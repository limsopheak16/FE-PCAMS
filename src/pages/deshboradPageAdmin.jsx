...
const DashboardAdmin = () => {
  ...
  return (
    <div className="container mx-auto p-6">
      <h1 className="text-3xl font-bold mb-4">Camp Overview</h1>

      <div className="mb-6 mt-6 flex flex-wrap gap-6 justify-between items-end">
      ...
      <div className="p-6 rounded-lg shadow-lg mb-12" style={{ backgroundColor: 'rgba(22, 95, 253, 0.1)' }}>
